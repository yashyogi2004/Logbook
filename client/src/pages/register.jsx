...
import { Mail, Lock, Eye, EyeOff, LogIn, AlertCircle, Sparkles, Shield,User} from 'lucide-react';
        ...
        <div className="group relative">
          ...
          <div className="relative bg-gray-900/80 backdrop-blur-xl border border-gray-800/50 rounded-3xl p-10 shadow-2xl">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-gray-400 text-lg">Sign up to continue your journey</p>
            </div>
